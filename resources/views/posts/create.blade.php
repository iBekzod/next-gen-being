        ...
        <div class="mb-8">
            ...
            <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 rounded">
                <p class="text-sm text-blue-900 dark:text-blue-200">
                    <span class="font-semibold">💡 Pro Tip:</span> Use AI Assistant to generate content and featured images automatically. All fields marked with <span class="text-red-500">*</span> are required.
                </p>
            </div>
        </div>

        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-0 bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            @csrf
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 text-white">
                <div class="grid grid-cols-4 gap-4 max-w-2xl">
                    <div class="text-center">
                        <div class="w-8 h-8 mx-auto bg-white text-blue-600 rounded-full flex items-center justify-center font-bold text-sm">1</div>
                        <p class="text-xs mt-2 font-medium">Content</p>
                    </div>
                    <div class="text-center">
                        <div class="w-8 h-8 mx-auto bg-white text-blue-600 rounded-full flex items-center justify-center font-bold text-sm">2</div>
                        <p class="text-xs mt-2 font-medium">Organization</p>
                    </div>
                    <div class="text-center">
                        <div class="w-8 h-8 mx-auto bg-white text-blue-600 rounded-full flex items-center justify-center font-bold text-sm">3</div>
                        <p class="text-xs mt-2 font-medium">Media</p>
                    </div>
                    <div class="text-center">
                        <div class="w-8 h-8 mx-auto bg-white text-blue-600 rounded-full flex items-center justify-center font-bold text-sm">4</div>
                        <p class="text-xs mt-2 font-medium">Publish</p>
                    </div>
                </div>
            </div>
                ...
                <div class="section-content p-6 space-y-6 hidden" id="ai-assistant">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <h4 class="text-sm font-semibold text-gray-900 dark:text-white">Generate Content with AI</h4>
                            <div class="group relative">
                                ...
                                <div class="absolute hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg z-10 whitespace-nowrap">
                                    AI writes full blog posts based on your topic. Perfect for creating comprehensive articles quickly.
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                <label for="ai_topic" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Topic or Keywords
                                    <span class="text-gray-500 dark:text-gray-400 font-normal">(required for AI generation)</span>
                                </label>
                                <input type="text"
                                       id="ai_topic"
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-600">
                        <div class="flex items-center gap-2 mb-4">
                            <h4 class="text-sm font-semibold text-gray-900 dark:text-white">Generate Featured Image</h4>
                            <div class="group relative">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400 cursor-help" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                                </svg>
                                <div class="absolute hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg z-10 whitespace-nowrap">
                                    Create unique, high-quality images using AI. Your readers will love the visual appeal!
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                <label for="ai_image_prompt" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Image Description
                                    <span class="text-gray-500 dark:text-gray-400 font-normal">(be specific for better results)</span>
                                </label>
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="section-content p-6 space-y-4 hidden" id="writing-assistant">
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                        <p class="text-sm text-blue-900 dark:text-blue-200">
                            AI-powered writing suggestions to improve your content quality, readability, and engagement.
                        </p>
                    </div>
                    <div class="grid grid-cols-2 gap-3">
                        <div class="group relative">
                            <button type="button" onclick="checkGrammar()" class="w-full py-2 px-3 bg-amber-100 dark:bg-amber-900/30 hover:bg-amber-200 dark:hover:bg-amber-900/50 text-amber-900 dark:text-amber-200 rounded-lg text-sm font-medium transition flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg z-10 whitespace-nowrap">
                                Scan for grammar errors, punctuation, and spelling mistakes
                            </div>
                        </div>
                        <div class="group relative">
                            <button type="button" onclick="analyzeStyle()" class="w-full py-2 px-3 bg-cyan-100 dark:bg-cyan-900/30 hover:bg-cyan-200 dark:hover:bg-cyan-900/50 text-cyan-900 dark:text-cyan-200 rounded-lg text-sm font-medium transition flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg z-10 whitespace-nowrap">
                                Get suggestions on tone, clarity, and writing conventions
                            </div>
                        </div>
                        <div class="group relative">
                            <button type="button" onclick="checkReadability()" class="w-full py-2 px-3 bg-green-100 dark:bg-green-900/30 hover:bg-green-200 dark:hover:bg-green-900/50 text-green-900 dark:text-green-200 rounded-lg text-sm font-medium transition flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg z-10 whitespace-nowrap">
                                Check reading difficulty and comprehension level
                            </div>
                        </div>
                        <div class="group relative">
                            <button type="button" onclick="analyzeTone()" class="w-full py-2 px-3 bg-pink-100 dark:bg-pink-900/30 hover:bg-pink-200 dark:hover:bg-pink-900/50 text-pink-900 dark:text-pink-200 rounded-lg text-sm font-medium transition flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg z-10 whitespace-nowrap">
                                Detect emotional tone and audience alignment
                            </div>
                        </div>
                    </div>
            ...
            <!-- ACTION BUTTONS -->
            <div class="bg-gradient-to-r from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 px-6 py-6 flex items-center justify-between border-t border-gray-200 dark:border-gray-600 sticky bottom-0">
                <a href="{{ route('dashboard.posts') }}"
                   class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 font-medium transition flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex space-x-3">
                    <button type="submit"
                            name="action"
                            value="save_draft"
                            class="px-6 py-2.5 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:border-gray-400 dark:hover:border-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-medium flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button type="submit"
                            name="action"
                            value="publish"
                            class="px-8 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg transition-colors font-medium shadow-md hover:shadow-lg flex items-center gap-2">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                        </svg>
